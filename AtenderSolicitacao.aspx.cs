...
public partial class adm_AtenderSolicitacao : System.Web.UI.Page
{
    ...
    protected void btnRedeCorporativa_Click(object sender, EventArgs e)
    {
        ...
        SolicitaAcessoDAO.Atualiza_Solicitacoes_setores_Update(idChamado, "RedeCorporativa");
    ...
    {
        int idChamado = Convert.ToInt32(id_Chamado.Text);
        SolicitaAcessoDAO.Atualiza_Solicitacoes_setores_Update(idChamado, "SGH");
        SolicitaAcessoDAO.Atualiza_Solicitante_dados_status(idChamado);
        Response.Redirect("~/adm/AtenderSolicitacao.aspx?IdChamado=" + idChamado);
    }
    ...
    {
        int idChamado = Convert.ToInt32(id_Chamado.Text);
        SolicitaAcessoDAO.Atualiza_Solicitacoes_setores_Update(idChamado, "Simproc");
        SolicitaAcessoDAO.Atualiza_Solicitante_dados_status(idChamado);
        Response.Redirect("~/adm/AtenderSolicitacao.aspx?IdChamado=" + idChamado);
    }
    ...
    {
        int idChamado = Convert.ToInt32(id_Chamado.Text);
        SolicitaAcessoDAO.Atualiza_Solicitacoes_setores_Update(idChamado, "Grafica");
        SolicitaAcessoDAO.Atualiza_Solicitante_dados_status(idChamado);
        Response.Redirect("~/adm/AtenderSolicitacao.aspx?IdChamado=" + idChamado);
    }
    ...
    {
        int idChamado = Convert.ToInt32(id_Chamado.Text);
        SolicitaAcessoDAO.Atualiza_Solicitacoes_setores_Update(idChamado, "OS_manutencao");
        SolicitaAcessoDAO.Atualiza_Solicitante_dados_status(idChamado);
        Response.Redirect("~/adm/AtenderSolicitacao.aspx?IdChamado=" + idChamado);
    }
    ...
    {
        int idChamado = Convert.ToInt32(id_Chamado.Text);
        SolicitaAcessoDAO.Atualiza_Solicitacoes_setores_Update(idChamado, "Sei");
        SolicitaAcessoDAO.Atualiza_Solicitante_dados_status(idChamado);
        Response.Redirect("~/adm/AtenderSolicitacao.aspx?IdChamado=" + idChamado);
    }
}