...
public partial class telaoChamado : System.Web.UI.Page
{
    ...
    private void carregaGrid()
    {
      ...
      ,[titulo],[ocorrencia],[dataHoraAbertura],[statusChamado] 
  FROM [chamado_suporte].[dbo].[aberturaChamado] where statusChamado= 0 or statusChamado= 11 or statusChamado= 12 order by id ASC";
                com.Open();
