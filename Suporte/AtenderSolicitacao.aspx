...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    ...
    <div class="container" id="printable">
        <h4 class="text-center fw-bold m-2">Atender Solicitação </h4>
        <div class="row m-2">
            <div class="col-auto">
        ...
        <asp:Panel runat="server" ID="PanelRedeCorporativa" BorderStyle="Double" GroupingText="Rede Corporativa" Visible="False" align="Center">
            <div id="DivRedeCorporativa">
                ...
                <br />
                <b>Obs: Opcional:</b>
            <asp:TextBox ID="txtObsFinalizarRedeCorporativa" runat="server" Width="80%"></asp:TextBox>
                <br />
        ...
        <asp:Panel runat="server" ID="PanelSGH" BorderStyle="Double" GroupingText="SGH" Visible="False" align="Center">
            <div id="DivSGH">
                ...
                <br />
                <b>Obs: Opcional:</b>
            <asp:TextBox ID="txtObsFinalizarSGH" runat="server" Width="80%"></asp:TextBox>
                <div class="nav justify-content-center m-3">
        ...
        <asp:Panel runat="server" ID="PanelSimproc" BorderStyle="Double" GroupingText="Simproc" Visible="False" HorizontalAlign="Center">
            <div id="DivSimproc">
             ...
             <br />
                <b>Obs: Opcional:</b>
            <asp:TextBox ID="txtObsFinalizarSimproc" runat="server" Width="80%"></asp:TextBox>
                <div class="nav justify-content-center m-3">
        ...
        <asp:Panel runat="server" ID="PanelGrafica" BorderStyle="Double" GroupingText="Central/Gráfica" Visible="False" HorizontalAlign="Center">
            <div id="DivGrafica">
             ...
             <br />
                <b>Obs: Opcional:</b>
            <asp:TextBox ID="txtObsFinalizarGrafica" runat="server" Width="80%"></asp:TextBox>
            <div class="nav justify-content-center m-3">
        ...
        <asp:Panel runat="server" ID="PanelOsManutencao" BorderStyle="Double" GroupingText="OS-Manutencao" Visible="False" HorizontalAlign="Center">
            <div id="OsManutencao">
                ...
                <br />
                <b>Obs: Opcional:</b>
            <asp:TextBox ID="txtObsFinalizarOSmanutencao" runat="server" Width="80%"></asp:TextBox>
                <div class="nav justify-content-center m-3">
        ...
        <asp:Panel runat="server" ID="PanelSEI" BorderStyle="Double" GroupingText="SEI" Visible="False" HorizontalAlign="Center">
            <div id="DivSei">
                ...
                <br />
                <b>Obs: Opcional:</b>
            <asp:TextBox ID="txtObsFinalizarSEI" runat="server" Width="80%"></asp:TextBox>
                <div class="nav justify-content-center m-3">
        ...
        <asp:Panel runat="server" ID="PanelSiga_Saude" BorderStyle="Double" GroupingText="Siga-Saúde" Visible="False" HorizontalAlign="Center">
            <div id="DivSigaSaude">
                ...
                <br />
              <b>Obs: Opcional:</b>
            <asp:TextBox ID="txtObsFinalizarSigaSaude" runat="server" Width="80%"></asp:TextBox>
                <div class="nav justify-content-center m-3">
                    <asp:Button ID="btnSigaSaude" runat="server" class="btn btn-outline-primary" Text="Finalizar Siga-Saude"
