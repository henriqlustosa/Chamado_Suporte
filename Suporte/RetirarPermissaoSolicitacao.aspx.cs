...
public partial class RetirarPermissaoSolicitacao : System.Web.UI.Page
{
    ...
    protected void btnRedeCorporativa_Click(object sender, EventArgs e)
    {
        ...
        SolicitaAcessoDAO.Atualiza_Solicitacoes_setores_Update(idChamado, "RedeCorporativa","R", 0);
        //SolicitaAcessoDAO.Atualiza_Solicitante_dados_status(idChamado);
        string dtHr = DateTime.Now.ToString();
        SolicitaAcessoDAO.Atualiza_Extrato(idChamado, ">>>-Rede Corporativa Removido por: " + pegaNomeLoginUsuario.Text + " em: " + dtHr + " OBS: " + txtObsFinalizar.Text + " \n");
        txtObsFinalizar.Text = "";
      
        Response.Redirect("~/Suporte/RetirarPermissaoSolicitacao.aspx?IdChamado=" + idChamado);
    }

    protected void bntSGH_Click(object sender, EventArgs e)
    {
        int idChamado = Convert.ToInt32(id_Chamado.Text);
        SolicitaAcessoDAO.Atualiza_Solicitacoes_setores_Update(idChamado, "SGH", "R", 0);
        if (LabelEmpresaExibe.Text!="HSPM")
        {
            SolicitaAcessoDAO.Atualiza_Solicitacoes_setores_Update(idChamado, "DadosSolicitadosSGH", "R", 0);
        }
        //SolicitaAcessoDAO.Atualiza_Solicitante_dados_status(idChamado);
        string dtHr = DateTime.Now.ToString();
        SolicitaAcessoDAO.Atualiza_Extrato(idChamado, ">>>-SGH Removido por: " + pegaNomeLoginUsuario.Text + " em: " + dtHr + " OBS: " + txtObsFinalizar.Text + " \n");
        txtObsFinalizar.Text = "";
    ...
    {
        int idChamado = Convert.ToInt32(id_Chamado.Text);
        SolicitaAcessoDAO.Atualiza_Solicitacoes_setores_Update(idChamado, "Simproc", "R", 0);
        //SolicitaAcessoDAO.Atualiza_Solicitante_dados_status(idChamado);
        string dtHr = DateTime.Now.ToString();
        SolicitaAcessoDAO.Atualiza_Extrato(idChamado, ">>>-Simproc Removido por: " + pegaNomeLoginUsuario.Text + " em: " + dtHr + " OBS: " + txtObsFinalizar.Text + " \n");
        txtObsFinalizar.Text = "";
    ...
    {
        int idChamado = Convert.ToInt32(id_Chamado.Text);
        SolicitaAcessoDAO.Atualiza_Solicitacoes_setores_Update(idChamado, "Grafica", "R", 0);
        //SolicitaAcessoDAO.Atualiza_Solicitante_dados_status(idChamado);
        string dtHr = DateTime.Now.ToString();
        SolicitaAcessoDAO.Atualiza_Extrato(idChamado, ">>>-Grafica Removido por: " + pegaNomeLoginUsuario.Text + " em: " + dtHr + " OBS: " + txtObsFinalizar.Text + " \n");
        txtObsFinalizar.Text = "";
    ...
    {
        int idChamado = Convert.ToInt32(id_Chamado.Text);
        SolicitaAcessoDAO.Atualiza_Solicitacoes_setores_Update(idChamado, "OS_manutencao", "R", 0);
        //SolicitaAcessoDAO.Atualiza_Solicitante_dados_status(idChamado);
        string dtHr = DateTime.Now.ToString();
        SolicitaAcessoDAO.Atualiza_Extrato(idChamado, ">>>-Os Manutenção Removido por: " + pegaNomeLoginUsuario.Text + " em: " + dtHr + " OBS: " + txtObsFinalizar.Text + " \n");
        txtObsFinalizar.Text = "";
    ...
    {
        int idChamado = Convert.ToInt32(id_Chamado.Text);
        SolicitaAcessoDAO.Atualiza_Solicitacoes_setores_Update(idChamado, "Sei", "R", 0);
        //SolicitaAcessoDAO.Atualiza_Solicitante_dados_status(idChamado);
        string dtHr = DateTime.Now.ToString();
        SolicitaAcessoDAO.Atualiza_Extrato(idChamado, ">>>-SEI Removido por: " + pegaNomeLoginUsuario.Text + " em: " + dtHr + " OBS: " + txtObsFinalizar.Text + " \n");
        txtObsFinalizar.Text = "";
    ...
    {
        int idChamado = Convert.ToInt32(id_Chamado.Text);
        SolicitaAcessoDAO.Atualiza_Solicitacoes_setores_Update(idChamado, "SigaSaude", "R", 0);
        //SolicitaAcessoDAO.Atualiza_Solicitante_dados_status(idChamado);
        string dtHr = DateTime.Now.ToString();
        SolicitaAcessoDAO.Atualiza_Extrato(idChamado, ">>>-Siga Saúde Removido por: " + pegaNomeLoginUsuario.Text + " em: " + dtHr + " OBS: " + txtObsFinalizar.Text + " \n");
        txtObsFinalizar.Text = "";
    ...
    {
        Response.Redirect("~/Suporte/SolicitacoesRemoverPermissao.aspx", false);
    }
}