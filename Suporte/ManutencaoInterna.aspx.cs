...
public partial class ExternosChamados : System.Web.UI.Page
{
    ...
    {
        GridViewChamadosMatencaoInterna.DataSource = ChamadosDAO.MostraChamadosNaTelaChamadosManutencaoLocal();
        GridViewChamadosMatencaoInterna.DataBind();
    ...
    protected void grdDadosPacienteSGH_RowCommand(object sender, GridViewCommandEventArgs e)//EXCLUIR CHAMADO
    {
        ...
        int id = Convert.ToInt32(GridViewChamadosMatencaoInterna.DataKeys[Convert.ToInt32(e.CommandArgument)].Value.ToString());
