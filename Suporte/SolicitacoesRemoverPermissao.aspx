<%@ Page Title="Solicitações Abertas" Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true" CodeFile="SolicitacoesRemoverPermissao.aspx.cs" Inherits="SolicitacoesRemoverPermissao" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
    ...
    <div class="container-fluid">
        ...
        <h3 class="title-content">Solicitações para remover permissões</h3>
        <div class="row">
            <div class="div-teste">
                <%-- <div class="col-12">--%>
                <div>
                ...
                <asp:TemplateField HeaderStyle-CssClass="sorting_disabled" HeaderText="Ação">
                 ...
                 <asp:TemplateField HeaderStyle-CssClass="sorting_disabled" HeaderText="Ação">
                    <ItemTemplate>
                        <div class="form-inline">
                            <div class="div-btngrid">
                                <asp:LinkButton ID="VisualizarS" CommandName="visualizarSolicitacao" CommandArgument='<%#((GridViewRow)Container).RowIndex%>'
                                    CssClass="button-grid" runat="server" HorizontalAlign="Center"> <!-- Text="Selecionar" -->
                                  Visualizar
                                </asp:LinkButton>
                            </div>
