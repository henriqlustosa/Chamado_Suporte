...
public partial class Suporte_VisualizarSolicitacoes : System.Web.UI.Page
{
    protected void Page_Load(object sender, EventArgs e)
    {
        if (!this.IsPostBack)
        {
            ...
            verificaCBK();
            id_ChamadoRetorno.Text = Request.QueryString["IdChamado2"];            
    ...
    private void verificaCBK_SituacaoNobanco(int id)
    {
        ...
        if (lista.RedeCorporativa == "S" || lista.RedeCorporativa == "C" || lista.RedeCorporativa == "E" || lista.RedeCorporativa == "R")
        {
            CkbExibeRedeCorporativa.Checked = true;
        }
        if (lista.SGH == "S" || lista.SGH == "C" || lista.SGH == "E" || lista.SGH == "R")
        {
            ckbExibeSGH.Checked = true;
        }
        if (lista.Simproc == "S" || lista.Simproc == "C" || lista.Simproc == "E" || lista.Simproc == "R")
        {
            ckbExibeSimproc.Checked = true;
        }
        if (lista.Grafica == "S" || lista.Grafica == "C" || lista.Grafica == "E" || lista.Grafica == "R")
        {
            ckbExibeGrafica.Checked = true;
        }
        if (lista.OS_manutencao == "S" || lista.OS_manutencao == "C" || lista.OS_manutencao == "E" || lista.OS_manutencao == "R")
        {
            ckbExibeOSmanutencao.Checked = true;
        }
        if (lista.Sei == "S" || lista.Sei == "C" || lista.Sei == "E" || lista.Sei == "R")
        {
            ckbExibeSEI.Checked = true;
        }
        if (lista.Siga_Saude == "S" || lista.Siga_Saude == "C" || lista.Siga_Saude == "E" || lista.Siga_Saude == "R")
        {
            ckbExibeSigaSaude.Checked = true;
        }
        if (lista.DadosSolicitadosSGH == "S" || lista.DadosSolicitadosSGH == "C" || lista.DadosSolicitadosSGH == "E" || lista.DadosSolicitadosSGH == "R")
        {
    ...
    protected void btnVoltar_Click(object sender, EventArgs e)
    {
        ...
        string url;
        if (id_ChamadoRetorno.Text=="")
        {
            url = "" + Global.localOrigem;            
        }
        else
        {
            url = "" + Global.localOrigem + "?IdChamado=" + Convert.ToInt32(id_ChamadoRetorno.Text);
        }
